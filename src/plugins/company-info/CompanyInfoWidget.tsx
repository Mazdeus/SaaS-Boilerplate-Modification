    ...
    <div className="border-b border-gray-200 bg-white p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="border-t border-gray-100 pt-3">
          <p className="mb-2 text-xs font-medium text-gray-700">Ikuti Kami</p>
          <div className="flex gap-2">
            <a
              href="https://www.instagram.com/brodo.footwear/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex size-8 items-center justify-center rounded-full bg-blue-50 text-blue-600 hover:bg-blue-100"
