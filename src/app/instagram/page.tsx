...
export default function InstagramPage() {
  ...
  useEffect(() => {
    ...
    script.src="https://www.juicer.io/embed/bro-do-16c4fdbe-b337-4f13-b891-f7ec4f0d6f83/embed-code.js";
    script.async = true;
    script.defer = true;
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {!showFallback && (
              <div className={`juicer-feed-container ${isLoading ? 'hidden' : ''}`}>
                <ul className="juicer-feed" data-feed-id="bro-do-16c4fdbe-b337-4f13-b891-f7ec4f0d6f83" data-per="12"></ul>
              </div>
            )}
